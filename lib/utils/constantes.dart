...
class DatosConstantes {
  ...
  // String dominio = 'http://192.168.0.26:8080';
  // String dominio = 'http://192.168.0.12:8080';
}
...
class EstilosApp {
  ...
  InputDecoration inputDecoration(
      ...
      double padingTop = 0.0,
      bool circular = true}) {
    return InputDecoration(
        contentPadding:
            EdgeInsets.symmetric(vertical: padingTop, horizontal: 15.0),
        hintText: hintText,
        border: OutlineInputBorder(
            borderRadius: BorderRadius.circular((circular) ? 50.0 : 0.0)),
